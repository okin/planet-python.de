...
BLOG_AUTHOR = "Niko Wenselowski"
BLOG_TITLE = "Planet Python Deutschland"
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://planetpy.auriga.uberspace.de"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://nikola.ralsina.com.ar"
BLOG_EMAIL = "niko@nerdno.de"
BLOG_DESCRIPTION = "Ein Planet für Python aus dem deutschsprachigen Raum."
...
SIDEBAR_LINKS = {
    DEFAULT_LANG: (
        ...
        ('/stories/mitmachen.html', '<strong>Mach mit!</strong>'),
...
DEPLOY_COMMANDS = ['rsync -rav output/* ~/html/']
